% SSC_compacc.m
% The 'SSC_compacc.m' is a modification of the original SSC code in which the error rate calculation code is changed to
% 'compacc', since the 'Misclassification' results in out-of-memory error when k is large, e.g. k>10.
%-------------------------'-------------------------------------------------
...
function [missrate, C, Theta] = SSC_compacc(X,r,affine,alpha,outlier,rho,s)
