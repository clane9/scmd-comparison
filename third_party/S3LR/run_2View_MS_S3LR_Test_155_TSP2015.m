% run_2View_MS_S3LR_Test_155_TSP2015.m
...
cd '../Hopkins155';
results_fn =['S3LR_MS_seq155_2view_resultsComparison_150points_TSP2015_',datestr(now,30),'.mat'];
addpath('../SSC_ADMM_v1.1');
%alpha = 50; %800;
miss_val_p =[0.05, 0.1, 0.15, 0.2, 0.25, 0.30];
%miss_val_p =[0.15];
alpha_arr =[25, 25, 25, 25, 25, 25];
...
for kk =1:size(miss_val_p,2)
    for ii =1:nTrials   % repeat 20 random trials       
        ...
        %end
            ...
            save(results_fn, 'iter_cell','ACC','MC_ERR', 'miss_val_p','nTrials','alpha','lambda_lrr',...
